...
public class ImportPlatformPage extends WizardPage {
	...
	public ImportData buildConfiguration() {
		return new ImportData(getPlatformDirectory().toPath(), isRemoveExistingProjects(), isFixClasspath(), isRemoveHybrisGenerator(), isCreateWorkingSets(), isUseMultiThread(), isSkipJarScanning());
	}
